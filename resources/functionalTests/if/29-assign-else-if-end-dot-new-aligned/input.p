...
if kindred = true then assign rachel = "Lynde" josephine = "Barry" muriel = "Stacy".
else if kindred = false then assign rachel = "gossip" josephine = "wealthy" muriel = "teacher".
else assign rachel = ? josephine = ? muriel = ?.
